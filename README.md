...
- Animal model data sourced from [abbash83/DS_Rodent_Models_Database](https://github.com/abbash83/DS_Rodent_Models_Database), updated from: Folz, A., Sloan, K., Roper, R.J. (2025). *Mouse Models of Down Syndrome*. Springer.
